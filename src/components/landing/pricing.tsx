      ...
      <div className="container px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto mt-12 items-stretch">
          ...
          <Card className="flex flex-col p-6 bg-gradient-to-br from-yellow-50 via-amber-100 to-yellow-50 border-4 border-amber-400 shadow-2xl rounded-2xl transition-transform hover:scale-105 relative overflow-hidden">
            <div className="absolute -top-4 -right-4 bg-amber-400 text-white font-bold px-4 py-2 rounded-bl-lg text-sm transform rotate-12 shadow-lg">O melhor para seu filho</div>
