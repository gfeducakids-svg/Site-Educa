  ...
  return (
    <section className="w-full py-12 md:py-24 lg:py-32 bg-background">
      <div className="container flex flex-col items-center gap-8 px-4 md:px-6">
        ...
        <Button asChild size="lg" className="h-auto py-4 px-8 text-xl font-headline bg-primary hover:bg-primary/90 text-primary-foreground shadow-lg animate-pulse">
